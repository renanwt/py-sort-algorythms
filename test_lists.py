import random
from sort_algorythms import quicksort, mergesort, selectionsort, bubblesort, insertionsort

random_list = random.sample(range(1, 1000), 42)
...
if __name__ == "__main__":
    test_cases = {'Random numbers': random_list,
